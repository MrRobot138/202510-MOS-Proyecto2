...
Este repositorio es la entrega 3 del proyecto, donde ** se entrega el caso 1 completo, y el caso 2 y 3 parcialmente implementados. ** 
...
Para correr cualquiera de los casos, son un Jupyter Notebook, el cual se espera que corra en el environment de pyomo dado para este curso. Antes de correr el notebook completo es importante tener Gurobi instalado. Este es el solver que utilizamos. Los siguientes comandos deberian funcionar:
